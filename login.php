...
body {
    background-image: url('./assets/img/26161796_0zun_56kz_211202.jpg'); 
...
<!-- <div class="container py-5">
 ...
 <!-- <form action="" method="POST">
        <div class="input_box ">
                            ...
                            <div class="d-grid mt-2">
                            <button class="btn btn-light" type="submit" name="kirim"><b>Login</b></button>
                        </div>
          </div>
                        </form>
                        <hr style="height: 10px;">
                        <p><center>Belum punya akun? <a href="register.php">Daftar disini!</center></a></p> -->
...
<div class="wrapper">
    <div class="login_box">
        ...
        <hr style="height: 10px;">
        <div class="register">
            <span><center>Belum punya akun? <a href="register.php"><u>Daftar disini</u>!</a></center></span>
        </div>
        </form>
