...
.ig-profile-container {
    ...
    margin-left: 180px;
    padding: 20px;
    box-shadow: 0 0 10px rgba(255,255,255,0.1); /* Bayangan box putih lembut */
    text-align: center;
    background-color: #1e1e1e; /* Warna latar belakang lebih gelap untuk kontainer */
}
...
<div class="ig-profile-container" >
        <div class="ig-profile-header" >
            ...
            <h1 id="profile-name" class="text-light">Nama : <?php echo $_SESSION['username']; ?></h1>
        ...
        <p class="text-white "><a href="home.php" style="text-decoration: none; color: white;">Album :</a> </p>
    <?php
...
<div class="main-content flex-grow-1" style="padding-left: 20px; padding-right: 20px;">
<div class="content p-3"style="border-top: 2px solid #737373 " >
   ...
   <a href=""><i class="fa-regular fa-comment"></i></a> 3 Komentar
    ...
    $userid = $_SESSION['userid']; // Ambil ID pengguna dari sesi yang sedang login

    $query = mysqli_query($koneksi, "SELECT foto.*, user.username, album.namaalbum 
                FROM foto 
...
<footer class="d-flex justify-content-center text-light bg-transparent ">
    ...
    <script>
    // Fungsi untuk menambahkan kelas 'clicked' saat tombol diklik
    function handleLikeButtonClick(button) {
        button.classList.add('clicked'); // Menambah kelas 'clicked' ke tombol yang diklik
    }
</script>
