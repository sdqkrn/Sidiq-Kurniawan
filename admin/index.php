...
<div class="d-flex">
<div class="d-flex flex-column flex-shrink-0 p-3 hide-sidebar" style="width: 180px; border-right: 1px solid #737373" id="sidebar">
...
?>
    ...
    if (mysqli_num_rows($ceksuka) == 1) { ?>
      <a href="../config/proses_like2.php?fotoid=<?php echo $data['fotoid'] ?>"class="like-button" type="submit" name="batalsuka"><i class="fa fa-heart"></i></a>
    <?php }else{ ?>

      <a href="../config/proses_like2.php?fotoid=<?php echo $data['fotoid'] ?>"class="like-button" type="submit" name="suka"><i class="fa-regular fa-heart"></i></a>
    <?php }
